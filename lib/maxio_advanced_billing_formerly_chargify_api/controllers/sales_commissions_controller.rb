...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class SalesCommissionsController < BaseController
    ...
    # seller account
    # @param [String] authorization Optional parameter: Example:Bearer
    # <<apiKey>>
    # @param [TrueClass | FalseClass] live_mode Optional parameter: Example:
    ...
    # @param [String] seller_id Required parameter: The Chargify id of your
    # seller account
    # @param [String] sales_rep_id Required parameter: Example:
    # @param [String] authorization Optional parameter: Example:Bearer
    # <<apiKey>>
    # @param [TrueClass | FalseClass] live_mode Optional parameter: Example:
    # @param [Integer] page Optional parameter: Result records are organized in
