...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class InvoicesController < BaseController
    ...
    # date specified.
    # @param [StatusEnum] status Optional parameter: The current status of the
    ...
    # @param [DirectionEnum] direction Optional parameter: The sort direction of
    # the returned invoices.
    ...
    # refunds data
    # @param [InvoiceDateFieldEnum] date_field Optional parameter: The type of
    ...
    # Allowed to be used only along with date_field set to created_at or
    # updated_at.
    # @param [Array[Object]] customer_ids Optional parameter: Allows fetching
    ...
    # @param [InvoiceSortFieldEnum] sort Optional parameter: Allows
    # specification of the order of the returned list. Use in query
    # `sort=total_amount`.
    ...
    # @param [String] since_date Optional parameter: Example:
    # @param [Integer] since_id Optional parameter: Example:
    # @param [Integer] page Optional parameter: Result records are organized in
    # pages. By default, the first page of results is displayed. The page
    # parameter specifies a page number of results to fetch. You can start
    # navigating through the pages to consume the results. You do this by
    ...
    # the query string. If there are no results to return, then an empty result
    # set will be returned. Use in query `page=1`.
    # @param [Integer] per_page Optional parameter: Example:100
    ...
    # @param [Array[InvoiceEventTypeEnum]] event_types Optional parameter:
    # Filter results by event_type. Supply a comma separated list of event types
    ...
    # allowed values is 200; any per_page value over 200 will be changed to 200.
    # Use in query `per_page=200`.
    # @param [DirectionEnum] direction Optional parameter: Sort direction of the
    # returned segments.
