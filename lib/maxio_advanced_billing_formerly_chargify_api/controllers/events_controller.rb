...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class EventsController < BaseController
    ...
    # @param [Integer] max_id Optional parameter: Example:
    # @param [DirectionEnum] direction Optional parameter: Example:desc
    # @param [Array[EventTypeEnum]] filter Optional parameter: You can pass
    # multiple event keys after comma. Use in query
    # `filter=signup_success,payment_success`.
    # @param [ListEventsDateFieldEnum] date_field Optional parameter: The type
    # of filter you would like to apply to your search.
