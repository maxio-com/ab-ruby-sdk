...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class SubscriptionsController < BaseController
    ...
    # @param [SubscriptionStateEnum] state Optional parameter: The current state
    # of the subscription
    ...
    # @param [SubscriptionDateFieldEnum] date_field Optional parameter: The type
    # of filter you'd like to apply to your search.  Allowed Values: ,
    ...
    # @param [SubscriptionSortEnum] sort Optional parameter: The attribute by
    # which to sort
    ...
    # @param [String] subscription_id Required parameter: The Chargify id of the
    # subscription
    # @param [Array[SubscriptionIncludeEnum]] include Optional parameter: Allows
    ...
    # @param [String] reference Optional parameter: Example:
    # @return [SubscriptionResponse] response from the API call
    ...
    # @param [String] subscription_id Required parameter: The Chargify id of the
    # subscription
    # @param [Integer] ack Optional parameter: id of the customer.
    # @param [Array[SubscriptionPurgeTypeEnum]] cascade Optional parameter:
