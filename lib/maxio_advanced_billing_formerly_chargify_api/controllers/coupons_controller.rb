...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class CouponsController < BaseController
    ...
    # @return [Array[Coupon]] response from the API call
    def list_coupons_for_product_family(product_family_id,
      ...
      new_api_call_builder
        ...
        .response(new_response_handler
                   .deserializer(APIHelper.method(:custom_type_deserializer))
                   .deserialize_into(Coupon.method(:from_hash))
    ...
    # allowed values is 200; any per_page value over 200 will be changed to 200.
    # Use in query `per_page=200`.
    # @param [BasicDateFieldEnum] date_field Optional parameter: The field was
    ...
    # @param [String] subcode Required parameter: Example:
