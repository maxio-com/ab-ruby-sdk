...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class SubscriptionInvoiceAccountController < BaseController
    ...
    # of filter you would like to apply to your search. created_at - Time when
    ...
    # @return [SubscriptionsPrepaymentsJsonResponse] response from the API call
    def list_prepayments(subscription_id,
      ...
      new_api_call_builder
        ...
        .response(new_response_handler
                   .deserializer(APIHelper.method(:custom_type_deserializer))
                   .deserialize_into(SubscriptionsPrepaymentsJsonResponse.method(:from_hash))
                   .local_error('401',
                                'Unauthorized',
                                APIException)
                   .local_error('403',
