...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class ComponentsController < BaseController
    ...
    # @param [ComponentKindPathEnum] component_kind Required parameter: The
    # component kind
    ...
    # @param [BasicDateFieldEnum] date_field Optional parameter: The type of
    ...
    # allowed values is 200; any per_page value over 200 will be changed to 200.
    # Use in query `per_page=200`.
    # @param [Array[PricePointTypeEnum]] filter_type Optional parameter: Use in
    ...
    # request.
    # @param [String] component_id Required parameter: Example:
    ...
    # to a Site.
    # @param [BasicDateFieldEnum] filter_date_field Optional parameter: The type
    # of filter you would like to apply to your search. Use in query:
    ...
    # end_date.
    # @param [ListComponentsPricePointsIncludeEnum] include Optional parameter:
    ...
    # will be used. If provided, this parameter will be used instead of
    # start_date.
    # @param [Array[PricePointTypeEnum]] filter_type Optional parameter: Allows
    # fetching price points with matching type. Use in query:
    # `filter[type]=custom,catalog`.
    # @param [SortingDirectionEnum | nil] direction Optional parameter: Controls
    # the order in which results are returned. Use in query `direction=asc`.
    # @param [Array[Integer]] filter_ids Optional parameter: Allows fetching
    # price points with matching id based on provided values. Use in query:
    # `filter[ids]=1,2,3`.
    # @param [IncludeNotNullEnum] filter_archived_at Optional parameter: Allows
