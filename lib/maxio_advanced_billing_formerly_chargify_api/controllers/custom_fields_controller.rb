...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class CustomFieldsController < BaseController
    ...
    # @param [ResourceTypeEnum] resource_type Required parameter: the resource
    # type to which the metafields belong
    ...
    # @param [Array[String]] names Optional parameter: Example:
    # @return [void] response from the API call
    ...
    # metadata for multiple records based on provided ids.
    # @param [SortingDirectionEnum | nil] direction Optional parameter: Controls
    # the order in which results are returned. Use in query `direction=asc`.
    # @return [PaginatedMetadata] response from the API call
