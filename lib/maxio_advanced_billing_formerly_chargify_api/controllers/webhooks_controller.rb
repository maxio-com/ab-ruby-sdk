...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class WebhooksController < BaseController
    ...
    # @param [WebhookStatusEnum] status Optional parameter: Webhooks with
    # matching status would be returned.
    ...
    # @param [WebhookOrderEnum] order Optional parameter: The order in which the
