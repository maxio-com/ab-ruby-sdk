...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class CreateOrUpdateCoupon < BaseModel
    ...
    def self.from_hash(hash)
      ...
      restricted_products = hash.key?('restricted_products') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:CreateOrUpdateCouponRestrictedProducts), hash['restricted_products']
      ) : SKIP
      restricted_components = hash.key?('restricted_components') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:CreateOrUpdateCouponRestrictedComponents), hash['restricted_components']
      ) : SKIP
