...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class Metafields < BaseModel
    ...
    def initialize(id = SKIP,
                   name = SKIP,
                   scope = SKIP,
                   input_type = MetafieldInputEnum::TEXT,
                   enum = SKIP)
    ...
    def self.from_hash(hash)
      ...
      input_type = hash['input_type'] ||= MetafieldInputEnum::TEXT
    ...
    # @param [Metafields | Hash] The value against the validation is performed.
