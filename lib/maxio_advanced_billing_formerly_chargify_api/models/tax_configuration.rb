...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class TaxConfiguration < BaseModel
    ...
    # @return [TaxConfigurationKindEnum]
    attr_accessor :kind

    # TODO: Write general description for this method
    # @return [TaxDestinationAddressEnum]
    ...
    def initialize(kind = TaxConfigurationKindEnum::CUSTOM,
    ...
    def self.from_hash(hash)
      ...
      kind = hash['kind'] ||= TaxConfigurationKindEnum::CUSTOM
      destination_address =
