...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class ProformaInvoice < BaseModel
    ...
    # Information about the seller (merchant) listed on the masthead of the
    # invoice.
    # @return [Array[ProformaInvoiceLineItem]]
    ...
    def self.from_hash(hash)
      ...
      customer = ProformaCustomer.from_hash(hash['customer']) if hash['customer']
      ...
      unless hash['line_items'].nil?
        ...
        hash['line_items'].each do |structure|
          line_items << (ProformaInvoiceLineItem.from_hash(structure) if structure)
        end
      end
      ...
      payments = hash.key?('payments') ? hash['payments'] : SKIP
      custom_fields = hash.key?('custom_fields') ? hash['custom_fields'] : SKIP
