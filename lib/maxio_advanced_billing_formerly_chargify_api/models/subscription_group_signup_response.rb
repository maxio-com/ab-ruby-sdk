...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class SubscriptionGroupSignupResponse < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [SignupCollectionMethodEnum]
    ...
    def initialize(uid = SKIP,
                   ...
                   subscriptions = SKIP,
                   payment_collection_method = SignupCollectionMethodEnum::AUTOMATIC)
    ...
    def self.from_hash(hash)
      ...
      payment_collection_method =
        hash['payment_collection_method'] ||= SignupCollectionMethodEnum::AUTOMATIC
