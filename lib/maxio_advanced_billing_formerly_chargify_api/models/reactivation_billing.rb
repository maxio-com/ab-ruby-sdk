...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class ReactivationBilling < BaseModel
    ...
    def initialize(reactivation_charge = ReactivationChargeEnum::PRORATED)
    ...
    def self.from_hash(hash)
      ...
      reactivation_charge =
        hash['reactivation_charge'] ||= ReactivationChargeEnum::PRORATED
