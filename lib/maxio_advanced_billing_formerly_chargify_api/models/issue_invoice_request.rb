...
module MaxioAdvancedBillingFormerlyChargifyApi
  ...
  class IssueInvoiceRequest < BaseModel
    ...
    # @return [FailedPaymentActionEnum]
    ...
    def initialize(on_failed_payment = FailedPaymentActionEnum::LEAVE_OPEN_INVOICE)
    ...
    def self.from_hash(hash)
      ...
      on_failed_payment =
        hash['on_failed_payment'] ||= FailedPaymentActionEnum::LEAVE_OPEN_INVOICE
