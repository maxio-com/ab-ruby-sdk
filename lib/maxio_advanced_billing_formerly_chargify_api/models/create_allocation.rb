  ...
  class CreateAllocation < BaseModel
    ...
    def self.from_hash(hash)
      ...
      quantity = hash.key?('quantity') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:CreateAllocationQuantity), hash['quantity']
      ) : nil
    ...
    def self.validate(value)
      if value.instance_of? self
        return UnionTypeLookUp.get(:CreateAllocationQuantity)
                              .validate(value.quantity)
      end

      return false unless value.instance_of? Hash

      UnionTypeLookUp.get(:CreateAllocationQuantity)
                     .validate(value['quantity'])
    end
  end
end
