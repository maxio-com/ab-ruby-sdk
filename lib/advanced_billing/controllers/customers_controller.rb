...
module AdvancedBilling
  ...
  class CustomersController < BaseController
    ...
    # The only validation restriction is that you can only create one customer
    ...
    # information. Alternatively, you can choose to leave `reference` blank, and
    # store the system-assigned unique ID for the customer, which is in the `id`
    # attribute.
    # For more information, see [Customer
    # Details](https://maxio.zendesk.com/hc/en-us/articles/24252190590093-Custom
    # er-Details).
    # ## Required Country Format
    # Format the country attribute of the customer using the ISO Standard
    # Country codes.
    ...
    # Format the state attribute of the customer using the ISO Standard State
    # codes.
    # + US States (two characters): see [ISO
    # 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2:US).
    # + States Outside the US (two to three characters): To find the correct
    # state codes outside the US, go to [ISO
    # 3166-1](http://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) and click
    # on the link in the “ISO 3166-2 codes” column next to the country you wish
    # to populate.
    # ## Locale
