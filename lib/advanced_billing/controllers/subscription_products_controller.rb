...
module AdvancedBilling
  ...
  class SubscriptionProductsController < BaseController
    ...
    # in the object when you send a POST request. You can also pass either a
    ...
    # passed, the subscription is moved to the product's default price point.
    # The response is the updated subscription.
    # ## Valid Subscriptions
    # Subscriptions should be in the `active` or `trialing` state to be
    # migrated.
    ...
    # Migrations](https://docs.maxio.com/hc/en-us/articles/24252069837581-Produc
