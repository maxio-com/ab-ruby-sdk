...
module AdvancedBilling
  ...
  class SubscriptionsController < BaseController
    ...
    # you want the billing address to be stored. The billing address and the
    # credit card information are stored together within the payment profile
    # object. Also, you cannot send a billing address without payment profile
    ...
    # Coupons-and-Subscriptions#removing-a-coupon).
    # @param [Integer] subscription_id Required parameter: The Chargify id of
    # the subscription.
    ...
    # subscription's state does not change. The subscription’s billing period
    ...
    # [Trialing
    # Subscriptions](https://maxio.zendesk.com/hc/en-us/articles/24252155721869-
    # Trialing-Subscriptions).
    # When the `revert_on_failure` parameter is set to `true`, the
    # subscription's state remains Trialing; the invoice from activation is
    # voided, and any prepayments and credits applied to the invoice are
