...
module AdvancedBilling
  ...
  class SubscriptionGroupStatusController < BaseController
    ...
    # Schedules all subscriptions within the specified group to be canceled at
    # the end of their billing period. The group is identified by its uid passed
    # in the URL.
    ...
    # Reactivates or resumes a cancelled subscription group. Upon reactivation,
    # any canceled invoices created after the beginning of the primary
    # subscription's billing period will be reopened and payment will be
    # attempted on them. If the subscription group is being reactivated (as
