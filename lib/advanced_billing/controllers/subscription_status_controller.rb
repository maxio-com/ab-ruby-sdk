...
module AdvancedBilling
  ...
  class SubscriptionStatusController < BaseController
    ...
    # in the UI on each Subscriber's Summary. For more information, see
    # [Subscriber Interface
    # Overview](https://maxio.zendesk.com/hc/en-us/articles/24252493695757-Subsc
    # riber-Interface-Overview).
    # ## Optional Component Fields
    # This endpoint is particularly useful because it returns the computed
    # billing amount for the base product and the components which are in use by
    # a subscriber.
    # By default, the preview includes billing details for all components _at
    ...
    # call to the renewal preview endpoint. End-of-period values for components
    # are not predicted, so metered or events-based usage may be less than it
    # will eventually be at the end of the period.
    # Optionally, **you can provide your own custom quantities** for any
    ...
    # modifying the subscription. This method previews data, but does not log
