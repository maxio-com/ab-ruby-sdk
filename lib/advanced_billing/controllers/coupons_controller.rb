...
module AdvancedBilling
  ...
  class CouponsController < BaseController
    ...
    # Returns a coupon by its Advanced Billing-assigned ID. You must identify
    ...
    # for validating coupon codes that are entered by a customer. If the coupon
    # is found and is valid, the coupon will be returned with a 200 status code.
