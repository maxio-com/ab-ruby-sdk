...
module AdvancedBilling
  ...
  class AllocationPreview < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} start_date: #{@start_date}, end_date: #{@end_date}, subtotal_in_cents:"\
      ...
      " direction: #{@direction}, proration_scheme: #{@proration_scheme}, line_items:"\
      " #{@line_items}, accrue_charge: #{@accrue_charge}, allocations: #{@allocations},"\
      " period_type: #{@period_type}, existing_balance_in_cents: #{@existing_balance_in_cents},"\
    ...
    def inspect
      ...
      " subtotal_in_cents: #{@subtotal_in_cents.inspect}, total_tax_in_cents:"\
      " #{@total_tax_in_cents.inspect}, total_discount_in_cents:"\
      " #{@total_discount_in_cents.inspect}, total_in_cents: #{@total_in_cents.inspect},"\
      " direction: #{@direction.inspect}, proration_scheme: #{@proration_scheme.inspect},"\
      " line_items: #{@line_items.inspect}, accrue_charge: #{@accrue_charge.inspect}, allocations:"\
      " #{@allocations.inspect}, period_type: #{@period_type.inspect}, existing_balance_in_cents:"\
