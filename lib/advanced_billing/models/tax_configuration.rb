...
module AdvancedBilling
  ...
  class TaxConfiguration < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} kind: #{@kind}, destination_address: #{@destination_address},"\
      " fully_configured: #{@fully_configured}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} kind: #{@kind.inspect}, destination_address:"\
      " #{@destination_address.inspect}, fully_configured: #{@fully_configured.inspect},"\
