...
module AdvancedBilling
  ...
  class CreatePaymentProfile < BaseModel
    ...
    def to_s
      ...
      " #{@cvv}, bank_name: #{@bank_name}, bank_iban: #{@bank_iban}, bank_routing_number:"\
      " #{@bank_routing_number}, bank_account_number: #{@bank_account_number}, bank_branch_code:"\
      " #{@bank_branch_code}, bank_account_type: #{@bank_account_type}, bank_account_holder_type:"\
      " #{@bank_account_holder_type}, last_four: #{@last_four}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@gateway_handle.inspect}, cvv: #{@cvv.inspect}, bank_name: #{@bank_name.inspect},"\
      " bank_iban: #{@bank_iban.inspect}, bank_routing_number: #{@bank_routing_number.inspect},"\
      " bank_account_number: #{@bank_account_number.inspect}, bank_branch_code:"\
      " #{@bank_branch_code.inspect}, bank_account_type: #{@bank_account_type.inspect},"\
      " bank_account_holder_type: #{@bank_account_holder_type.inspect}, last_four:"\
      " #{@last_four.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
