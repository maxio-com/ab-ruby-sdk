...
module AdvancedBilling
  ...
  class UnitPriceMeteredComponent < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      UnitPriceMeteredComponent.new()
    end

    # Validates an instance of the object from a given value.
    # @param [UnitPriceMeteredComponent | Hash] The value against the validation is performed.
