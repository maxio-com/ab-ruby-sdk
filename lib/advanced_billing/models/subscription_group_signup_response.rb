...
module AdvancedBilling
  ...
  class SubscriptionGroupSignupResponse < BaseModel
    ...
    def to_s
      ...
      " #{@cancel_at_end_of_period}, subscriptions: #{@subscriptions}, payment_collection_method:"\
      " #{@payment_collection_method}, additional_properties: #{get_additional_properties}>"
    end
    ...
    def inspect
      ...
      " subscriptions: #{@subscriptions.inspect}, payment_collection_method:"\
      " #{@payment_collection_method.inspect}, additional_properties:"\
