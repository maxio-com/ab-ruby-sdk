...
module AdvancedBilling
  # CouponCouponResponse Model.
  class CouponCouponResponse < BaseModel
    SKIP = Object.new
    ...
    # TODO: Write general description for this method
    # @return [CompoundingStrategyCoupon]
    ...
    def self.from_hash(hash)
      ...
      compounding_strategy = hash.key?('compounding_strategy') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:CouponCouponResponseCompoundingStrategy), hash['compounding_strategy']
      ) : SKIP
      use_site_exchange_rate =
    ...
    # @param [CouponCouponResponse | Hash] The value against the validation is performed.
