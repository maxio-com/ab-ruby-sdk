...
module AdvancedBilling
  # ScheduledRenewalUpdateRequest Model.
  class ScheduledRenewalUpdateRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      renewal_configuration_item = hash.key?('renewal_configuration_item') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:ScheduledRenewalUpdateRequestRenewalConfigurationItem), hash['renewal_configuration_item']
      ) : nil
      ...
      ScheduledRenewalUpdateRequest.new(renewal_configuration_item: renewal_configuration_item,
                                        additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [ScheduledRenewalUpdateRequest | Hash] The value against the validation is performed.
