...
module AdvancedBilling
  # UpdateCurrencyPricesRequest Model.
  class UpdateCurrencyPricesRequest < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [Array[UpdateCurrencyPrice]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['currency_prices'].nil?
        ...
        hash['currency_prices'].each do |structure|
          currency_prices << (UpdateCurrencyPrice.from_hash(structure) if structure)
        end
      end
