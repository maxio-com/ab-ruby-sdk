...
module AdvancedBilling
  ...
  class MRRMovement < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} amount: #{@amount}, category: #{@category}, subscriber_delta:"\
      " #{@subscriber_delta}, lead_delta: #{@lead_delta}, additional_properties:"\
    ...
    def inspect
      ...
      " subscriber_delta: #{@subscriber_delta.inspect}, lead_delta: #{@lead_delta.inspect},"\
