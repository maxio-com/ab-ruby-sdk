...
module AdvancedBilling
  ...
  class CreateOnOffComponent < BaseModel
    ...
    def initialize(on_off_component:, additional_properties: {})
    ...
    def to_s
      ...
      "<#{class_name} on_off_component: #{@on_off_component}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} on_off_component: #{@on_off_component.inspect}, additional_properties:"\
      " #{get_additional_properties}>"
    end
  end
end
