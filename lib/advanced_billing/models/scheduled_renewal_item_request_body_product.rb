...
module AdvancedBilling
  ...
  class ScheduledRenewalItemRequestBodyProduct < BaseModel
    SKIP = Object.new
    ...
    # @return [ScheduledRenewalProductPricePoint]
    ...
    def self.from_hash(hash)
      ...
      custom_price = ScheduledRenewalProductPricePoint.from_hash(hash['custom_price']) if
        hash['custom_price']
      ...
      ScheduledRenewalItemRequestBodyProduct.new(item_id: item_id,
    ...
    # @param [ScheduledRenewalItemRequestBodyProduct | Hash] The value against the validation is performed.
