...
module AdvancedBilling
  # BulkUpdateSegments Model.
  class BulkUpdateSegments < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [Array[BulkUpdateSegmentsItem]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['segments'].nil?
        ...
        hash['segments'].each do |structure|
          segments << (BulkUpdateSegmentsItem.from_hash(structure) if structure)
        end
      end
      ...
      BulkUpdateSegments.new(segments: segments,
