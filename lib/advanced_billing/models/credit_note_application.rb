...
module AdvancedBilling
  ...
  class CreditNoteApplication < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} uid: #{@uid}, transaction_time: #{@transaction_time}, invoice_uid:"\
      " #{@invoice_uid}, memo: #{@memo}, applied_amount: #{@applied_amount},"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} uid: #{@uid.inspect}, transaction_time: #{@transaction_time.inspect},"\
      " invoice_uid: #{@invoice_uid.inspect}, memo: #{@memo.inspect}, applied_amount:"\
      " #{@applied_amount.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
