...
module AdvancedBilling
  ...
  class QuantityCreateInvoiceItem < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      QuantityCreateInvoiceItem.new()
    end

    # Validates an instance of the object from a given value.
    # @param [QuantityCreateInvoiceItem | Hash] The value against the validation is performed.
