...
module AdvancedBilling
  ...
  class PreviewAllocationsRequest < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} allocations: #{@allocations}, effective_proration_date:"\
      " #{@effective_proration_date}, upgrade_charge: #{@upgrade_charge}, downgrade_credit:"\
      " #{@downgrade_credit}, additional_properties: #{get_additional_properties}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} allocations: #{@allocations.inspect}, effective_proration_date:"\
      " #{@effective_proration_date.inspect}, upgrade_charge: #{@upgrade_charge.inspect},"\
      " downgrade_credit: #{@downgrade_credit.inspect}, additional_properties:"\
