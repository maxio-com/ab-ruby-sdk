...
module AdvancedBilling
  # CreateProductPricePointRequest Model.
  class CreateProductPricePointRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      price_point = CreateProductPricePoint.from_hash(hash['price_point']) if hash['price_point']

      # Clean out expected properties from Hash.
      additional_properties = hash.reject { |k, _| names.value?(k) }

      # Create object from extracted values.
      CreateProductPricePointRequest.new(price_point: price_point,
