...
module AdvancedBilling
  ...
  class SubscriptionGroupSignup < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} payment_profile_id: #{@payment_profile_id}, payer_id: #{@payer_id},"\
      " payer_reference: #{@payer_reference}, payment_collection_method:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} payment_profile_id: #{@payment_profile_id.inspect}, payer_id:"\
      " #{@payer_id.inspect}, payer_reference: #{@payer_reference.inspect},"\
