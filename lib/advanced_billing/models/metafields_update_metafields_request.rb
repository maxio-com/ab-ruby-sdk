...
module AdvancedBilling
  # MetafieldsUpdateMetafieldsRequest Model.
  class MetafieldsUpdateMetafieldsRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      MetafieldsUpdateMetafieldsRequest.new(current_name,
                                            name,
                                            scope,
                                            input_type,
                                            enum)
    ...
    # @param [MetafieldsUpdateMetafieldsRequest | Hash] The value against the validation is performed.
