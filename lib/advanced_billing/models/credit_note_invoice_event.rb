...
module AdvancedBilling
  # CreditNoteInvoiceEvent Model.
  class CreditNoteInvoiceEvent < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      customer = CustomerCreditNote.from_hash(hash['customer']) if hash['customer']
      ...
      CreditNoteInvoiceEvent.new(uid,
                                 site_id,
                                 customer_id,
                                 subscription_id,
                                 number,
