...
module AdvancedBilling
  ...
  class VoidInvoiceEventDataAnyOf8 < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      VoidInvoiceEventDataAnyOf8.new(credit_note_attributes,
                                     memo,
                                     applied_amount,
                                     transaction_time)
    end
    ...
    # @param [VoidInvoiceEventDataAnyOf8 | Hash] The value against the validation is performed.
