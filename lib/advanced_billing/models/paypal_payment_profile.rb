...
module AdvancedBilling
  ...
  class PaypalPaymentProfile < BaseModel
    ...
    def initialize(payment_type: PaymentType::PAYPAL_ACCOUNT, id: SKIP,
                   ...
                   gateway_handle: SKIP, paypal_email: SKIP, created_at: SKIP,
    ...
    def to_s
      ...
      " #{@paypal_email}, created_at: #{@created_at}, updated_at: #{@updated_at},"\
    ...
    def inspect
      ...
      " #{@gateway_handle.inspect}, paypal_email: #{@paypal_email.inspect}, created_at:"\
