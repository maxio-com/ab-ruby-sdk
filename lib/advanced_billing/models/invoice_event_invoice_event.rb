...
module AdvancedBilling
  ...
  class InvoiceEventInvoiceEvent < BaseModel
    SKIP = Object.new
    ...
    # @return [PaymentMethodNestedDataInvoiceEvent]
    ...
    def self.from_hash(hash)
      ...
      payment_method = hash.key?('payment_method') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:InvoiceEventInvoiceEventPaymentMethod), hash['payment_method']
      ) : SKIP
      transaction_id =
      ...
      credit_note_attributes = CreditNoteInvoiceEvent.from_hash(hash['credit_note_attributes']) if
      ...
      InvoiceEventInvoiceEvent.new(uid,
                                   credit_note_number,
                                   credit_note_uid,
                                   original_amount,
                                   applied_amount,
    ...
    # @param [InvoiceEventInvoiceEvent | Hash] The value against the validation is performed.
