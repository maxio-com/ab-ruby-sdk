...
module AdvancedBilling
  # SubscriptionProductChangeScheduled Model.
  class SubscriptionProductChangeScheduled < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      SubscriptionProductChangeScheduled.new(previous_product_id: previous_product_id,
                                             new_product_id: new_product_id,
    ...
    # @param [SubscriptionProductChangeScheduled | Hash] The value against the validation is performed.
