...
module AdvancedBilling
  ...
  class UnitPriceQuantityBasedComponent < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      UnitPriceQuantityBasedComponent.new()
    end

    # Validates an instance of the object from a given value.
    # @param [UnitPriceQuantityBasedComponent | Hash] The value against the validation is performed.
