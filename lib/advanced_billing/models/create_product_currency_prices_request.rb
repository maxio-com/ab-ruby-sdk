...
module AdvancedBilling
  # CreateProductCurrencyPricesRequest Model.
  class CreateProductCurrencyPricesRequest < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [Array[CreateProductCurrencyPrice]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['currency_prices'].nil?
        ...
        hash['currency_prices'].each do |structure|
          currency_prices << (CreateProductCurrencyPrice.from_hash(structure) if structure)
        end
      end
      ...
      CreateProductCurrencyPricesRequest.new(currency_prices: currency_prices,
