...
module AdvancedBilling
  # InvoiceLineItem2 Model.
  class InvoiceLineItem2 < BaseModel
    SKIP = Object.new
    ...
    # @param [InvoiceLineItem2 | Hash] The value against the validation is performed.
