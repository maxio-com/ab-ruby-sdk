...
module AdvancedBilling
  ...
  class UnitPricePrepaidUsageComponent < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      UnitPricePrepaidUsageComponent.new()
    end

    # Validates an instance of the object from a given value.
    # @param [UnitPricePrepaidUsageComponent | Hash] The value against the validation is performed.
