...
module AdvancedBilling
  ...
  class PricePointIdCreateAllocation < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      PricePointIdCreateAllocation.new()
    end

    # Validates an instance of the object from a given value.
    # @param [PricePointIdCreateAllocation | Hash] The value against the validation is performed.
