...
class SubscriptionsControllerTests < ControllerTestBase
  ...
  def test_create_subscription
    ...
    body = CreateSubscriptionRequest.from_hash(APIHelper.json_deserialize(
      '{"subscription":{"product_handle":"basic","customer_attributes":{"first'\
      '_name":"Joe","last_name":"Blow","email":"joe@example.com","zip":"02120"'\
      ',"state":"MA","reference":"XYZ","phone":"(617) 111 - 0000","organizatio'\
      'n":"Acme","country":"US","city":"Boston","address_2":null,"address":"12'\
      '3 Mass Ave."},"credit_card_attributes":{"last_name":"Smith","first_name'\
      '":"Joe","full_number":"4111111111111111","expiration_year":"2021","expi'\
      'ration_month":"1","card_type":"visa","billing_zip":"02120","billing_sta'\
      'te":"MA","billing_country":"US","billing_city":"Boston","billing_addres'\
      's_2":null,"billing_address":"123 Mass Ave."}}}', false))
    ...
    expected_body = JSON.parse(
      ...
      'otal_revenue_in_cents":14000,"product_price_in_cents":1000,"product_ver'\
      'sion_number":7,"current_period_ends_at":"2016-11-15T14:48:10-05:00","ne'\
      'xt_assessment_at":"2016-11-15T14:48:10-05:00","trial_started_at":null,"'\
      'trial_ended_at":null,"activated_at":"2016-11-14T14:48:12-05:00","expire'\
      's_at":null,"created_at":"2016-11-14T14:48:10-05:00","updated_at":"2016-'\
      '11-14T15:24:41-05:00","cancellation_message":null,"cancellation_method"'\
      ':"merchant_api","cancel_at_end_of_period":null,"canceled_at":null,"curr'\
      'ent_period_started_at":"2016-11-14T14:48:10-05:00","previous_state":"ac'\
      'tive","signup_payment_id":162269766,"signup_revenue":"260.00","delayed_'\
      'cancel_at":null,"coupon_code":"5SNN6HFK3GBH","payment_collection_method'\
      '":"automatic","snap_day":null,"reason_code":null,"receives_invoice_emai'\
      'ls":false,"customer":{"first_name":"Curtis","last_name":"Test","email":'\
      '"curtis@example.com","cc_emails":"jeff@example.com","organization":"","'\
      'reference":null,"id":14714298,"created_at":"2016-11-14T14:48:10-05:00",'\
      '"updated_at":"2016-11-14T14:48:13-05:00","address":"123 Anywhere Street'\
      '","address_2":"","city":"Boulder","state":"CO","zip":"80302","country":'\
      '"US","phone":"","verified":false,"portal_customer_created_at":"2016-11-'\
      '14T14:48:13-05:00","portal_invite_last_sent_at":"2016-11-14T14:48:13-05'\
      ':00","portal_invite_last_accepted_at":null,"tax_exempt":false,"vat_numb'\
      'er":"012345678"},"product":{"id":3792003,"name":"$10 Basic Plan","handl'\
      'e":"basic","description":"lorem ipsum","accounting_code":"basic","price'\
      '_in_cents":1000,"interval":1,"interval_unit":"day","initial_charge_in_c'\
      'ents":null,"expiration_interval":null,"expiration_interval_unit":"never'\
      '","trial_price_in_cents":null,"trial_interval":null,"trial_interval_uni'\
      't":"month","initial_charge_after_trial":false,"return_params":"","reque'\
      'st_credit_card":false,"require_credit_card":false,"created_at":"2016-03'\
      '-24T13:38:39-04:00","updated_at":"2016-11-03T13:03:05-04:00","archived_'\
      'at":null,"update_return_url":"","update_return_params":"","product_fami'\
      'ly":{"id":527890,"name":"Acme Projects","handle":"billing-plans","accou'\
      'nting_code":null,"description":""},"public_signup_pages":[{"id":281054,'\
      '"url":"https://general-goods.chargify.com/subscribe/kqvmfrbgd89q/basic"'\
      '},{"id":281240,"url":"https://general-goods.chargify.com/subscribe/dkff'\
      'ht5dxfd8/basic"},{"id":282694,"url":"https://general-goods.chargify.com'\
      '/subscribe/jwffwgdd95s8/basic"}],"taxable":false,"version_number":7,"pr'\
      'oduct_price_point_name":"Default"},"credit_card":{"id":10191713,"paymen'\
      't_type":"credit_card","first_name":"Curtis","last_name":"Test","masked_'\
      'card_number":"XXXX-XXXX-XXXX-1","card_type":"bogus","expiration_month":'\
      '1,"expiration_year":2026,"billing_address":"123 Anywhere Street","billi'\
      'ng_address_2":"","billing_city":"Boulder","billing_state":null,"billing'\
      '_country":"","billing_zip":"80302","current_vault":"bogus","vault_token'\
      '":"1","customer_vault_token":null,"customer_id":14714298},"payment_type'\
      '":"credit_card","referral_code":"w7kjc9","next_product_id":null,"coupon'\
      '_use_count":1,"coupon_uses_allowed":1,"next_product_handle":null,"store'\
      'd_credential_transaction_id":125566112256688,"dunning_communication_del'\
      'ay_enabled":true,"dunning_communication_delay_time_zone":"Eastern Time '\
      '(US & Canada)"}}'
    )
  ...
  def test_list_subscriptions
    ...
    options['state'] = nil
    options['product'] = nil
    options['product_price_point_id'] = nil
    options['coupon'] = nil
    options['date_field'] = nil
    options['start_date'] = Date.parse('2022-07-01')
    options['end_date'] = Date.parse('2022-08-01')
    options['start_datetime'] = DateTimeHelper.from_rfc3339('2022-07-01 09:00:05')
    options['end_datetime'] = DateTimeHelper.from_rfc3339('2022-08-01 10:00:05')
    options['metadata'] = nil
    options['direction'] = nil
    options['sort'] = 'signup_date'

    # Perform the API call through the SDK function
    result = @controller.list_subscriptions(options)
  ...
  def test_read_subscription_by_reference
    # Parameters for the API call
    reference = nil

    # Perform the API call through the SDK function
    result = @controller.read_subscription_by_reference(reference: reference)
  ...
  def test_preview_subscription
    # Parameters for the API call
    body = CreateSubscriptionRequest.from_hash(APIHelper.json_deserialize(
      '{"subscription":{"product_handle":"gold-product"}}', false))

    # Perform the API call through the SDK function
    result = @controller.preview_subscription(body: body)
    ...
    refute_nil(result)
    expected_body = JSON.parse(
      '{"subscription_preview":{"current_billing_manifest":{"line_items":[{"tr'\
      'ansaction_type":"charge","kind":"baseline","amount_in_cents":5000,"memo'\
      '":"Gold Product (08/21/2018 - 09/21/2018)","discount_amount_in_cents":0'\
      ',"taxable_amount_in_cents":0,"product_id":1,"product_handle":"gold-prod'\
      'uct","product_name":"Gold Product"},{"transaction_type":"charge","kind"'\
      ':"component","amount_in_cents":28000,"memo":"Component name: 14 Unit na'\
      'mes","discount_amount_in_cents":0,"taxable_amount_in_cents":0,"componen'\
      't_id":462149,"component_handle":"handle","component_name":"Component na'\
      'me"},{"transaction_type":"charge","kind":"component","amount_in_cents":'\
      '2000,"memo":"Fractional Metered Components: 20.0 Fractional Metereds","'\
      'discount_amount_in_cents":0,"taxable_amount_in_cents":0,"component_id":'\
      '426665,"component_handle":"handle","component_name":"Fractional Metered'\
      ' Components"},{"transaction_type":"charge","kind":"component","amount_i'\
      'n_cents":0,"memo":"On/Off Component","discount_amount_in_cents":0,"taxa'\
      'ble_amount_in_cents":0,"component_id":426670,"component_handle":"handle'\
      '","component_name":"On/Off Component"},{"transaction_type":"adjustment"'\
      ',"kind":"coupon","amount_in_cents":0,"memo":"Coupon: 1DOLLAR - You only'\
      ' get $1.00 off","discount_amount_in_cents":0,"taxable_amount_in_cents":'\
      '0}],"total_in_cents":35000,"total_discount_in_cents":0,"total_tax_in_ce'\
      'nts":0,"subtotal_in_cents":35000,"start_date":"2018-08-21T21:25:21Z","e'\
      'nd_date":"2018-09-21T21:25:21Z","period_type":"recurring","existing_bal'\
      'ance_in_cents":0},"next_billing_manifest":{"line_items":[{"transaction_'\
      'type":"charge","kind":"baseline","amount_in_cents":5000,"memo":"Gold Pr'\
      'oduct (09/21/2018 - 10/21/2018)","discount_amount_in_cents":0,"taxable_'\
      'amount_in_cents":0,"product_id":1,"product_handle":"gold-product","prod'\
      'uct_name":"Gold Product"},{"transaction_type":"charge","kind":"componen'\
      't","amount_in_cents":28000,"memo":"Component name: 14 Unit names","disc'\
      'ount_amount_in_cents":0,"taxable_amount_in_cents":0,"component_id":4621'\
      '49,"component_handle":"handle","component_name":"Component name"},{"tra'\
      ...
      '"On/Off Component"}],"total_in_cents":33000,"total_discount_in_cents":0'\
      ',"total_tax_in_cents":0,"subtotal_in_cents":33000,"start_date":"2018-09'\
      '-21T21:25:21Z","end_date":"2018-10-21T21:25:21Z","period_type":"recurri'\
      'ng","existing_balance_in_cents":0}}}'
    )
    received_body = JSON.parse(@response_catcher.response.raw_body)
    assert(ComparisonHelper.match_body(expected_body, received_body))
  end
