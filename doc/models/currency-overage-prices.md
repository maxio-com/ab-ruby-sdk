...
| `currency_overage_prices` | [`Array[ComponentCurrencyPrice]`](../../doc/models/component-currency-price.md) | Optional | Applicable only to prepaid usage components. An array of currency pricing data for overage prices. |

## Example

```ruby
currency_overage_prices = CurrencyOveragePrices.new(
  id: 26,
