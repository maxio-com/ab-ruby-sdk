...
| `use_credits_and_prepayments` | `TrueClass \| FalseClass` | Optional | If true is sent, Advanced Billing will use service credits and prepayments upon reactivation. If false is sent, the service credits and prepayments will be ignored. |
...
```ruby
reactivate_subscription_request = ReactivateSubscriptionRequest.new(
