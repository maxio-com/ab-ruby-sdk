...
| `snap_day` | `String` | Optional | A day of month that subscription will be processed on. Can be 1 up to 28 or 'end'. |
...
| `reason_code` | `String` | Optional | The churn reason code associated to a canceled subscription. |
...
subscription = Subscription.new(
  ...
  credit_card: CreditCardPaymentProfile.new(
