...
|  --- | --- | --- | --- |
| `ids` | `Array[Integer]` | Optional | Allows fetching products with matching id based on provided values. Use in query `filter[ids]=1,2,3`.<br><br>**Constraints**: *Minimum Items*: `1` |
...
```ruby
list_products_filter = ListProductsFilter.new(
  ids: [
    1,
    2,
    3
  ],
  prepaid_product_price_point: PrepaidProductPricePointFilter.new(
