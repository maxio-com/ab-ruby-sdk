...
| `period_range_start` | `String` | Optional | Start date for the period credited by this line. The format is `"YYYY-MM-DD"`. |
| `period_range_end` | `String` | Optional | End date for the period credited by this line. The format is `"YYYY-MM-DD"`. |
