...
| `decimal_quantity` | `String` | Optional | Decimal representation of the allocated quantity. Only valid when decimal<br>allocations are enabled for the component. |
...
| `decimal_previous_quantity` | `String` | Optional | Decimal representation of `previous_quantity`. Only valid when decimal<br>allocations are enabled for the component. |
...
```ruby
create_allocation = CreateAllocation.new(
  quantity: 176.5,
