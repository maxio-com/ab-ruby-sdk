...
| `event_type` | [`InvoiceEventType`](../../doc/models/invoice-event-type.md) | Required | **Default**: `InvoiceEventType::VOID_REMAINDER` |
...
```ruby
void_remainder_event = VoidRemainderEvent.new(
  id: 204,
