...
result = subscriptions_controller.create_subscription(body: body)
puts result
```
...
| `product` | Integer \| String \| nil | Query, Optional | This is a container for one-of cases. |
...
| `customer_id` | `Integer` | Query, Optional | The Advanced Billing id of the customer. |
...
| `branding_theme_id` | `Integer` | Query, Optional | Filter subscriptions by the ID of an assigned Branding Theme. Branding Themes is a beta feature. See [Understand Branding Themes](https://docs.maxio.com/hc/en-us/articles/43796895662093-Understand-Branding-Themes#understand-branding-themes-0-0) for more information. |
...
| `dunning_exemption` | `TrueClass \| FalseClass` | Query, Optional | Filter by dunning exemption status. |
